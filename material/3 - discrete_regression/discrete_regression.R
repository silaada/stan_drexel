...
setwd('/home/sila/stan_drexel/material/3 - discrete_regression/')
...
############################################################
# Fit a Poisson GLM by explicitly exponenentiation
############################################################

input_data <- read_rdump('discrete_regression.data.R')
fit <- stan(file='poisson1.stan', data=input_data, seed=4938483)
...
############################################################
# Fit a Poisson GLM using Stan's GLM mass function
############################################################

fit <- stan(file='poisson2.stan', data=input_data, seed=4938483)
