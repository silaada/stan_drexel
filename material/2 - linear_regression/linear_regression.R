...
setwd('/home/sila/stan_drexel/material/2 - linear_regression/')
...
# used "fixed parameters" to not running an MCMC algorithm - no needed
...
# Plot marginal posteriors verses the corresonding priors
params = extract(fit)
...
hist(abs(rnorm(100000, 0, 5)), breaks=seq(0, 25, 0.01), prob=T,
     col=c_light, border=c_light_highlight, main="",
     xlim=c(0, 5), xlab="sigma", yaxt='n', ylim=c(0, 15), ylab="")
hist(params$sigma, breaks=seq(0, 5, 0.01), prob=T,
     col=c_dark, border=c_dark_highlight, add=T)
abline(v=1, col=c_light, lty=1, lw=2)

hist(rnorm(100000, 0, 10), breaks=seq(-50, 50, 0.05), prob=T,
     col=c_light, border=c_light_highlight, main="",
     xlim=c(-10, 10), xlab="alpha", yaxt='n', ylim=c(0, 5), ylab="")
hist(params$alpha, breaks=seq(-50, 50, 0.05), prob=T,
     col=c_dark, border=c_dark_highlight, add=T)
abline(v=10, col=c_light, lty=1, lw=2)

hist(rnorm(100000, 0, 10), breaks=seq(-50, 50, 0.2), prob=T,
     col=c_light, border=c_light_highlight, main="",
     xlim=c(-10, 10), xlab="beta[1]", yaxt='n', ylim=c(0, 1.5), ylab="")
hist(params$beta[,1], breaks=seq(-50, 50, 0.2), prob=T,
     col=c_dark, border=c_dark_highlight, add=T)
abline(v=5, col=c_light, lty=1, lw=2)

hist(rnorm(100000, 0, 10), breaks=seq(-50, 50, 0.2), prob=T,
     col=c_light, border=c_light_highlight, main="",
     xlim=c(-10, 10), xlab="beta[2]", yaxt='n', ylim=c(0, 1.5), ylab="")
hist(params$beta[,2], breaks=seq(-50, 50, 0.2), prob=T,
     col=c_dark, border=c_dark_highlight, add=T)
abline(v=-3, col=c_light, lty=1, lw=2)

hist(rnorm(100000, 0, 10), breaks=seq(-50, 50, 0.2), prob=T,
     col=c_light, border=c_light_highlight, main="",
     xlim=c(-10, 10), xlab="beta[3]", yaxt='n', ylim=c(0, 1.5), ylab="")
hist(params$beta[,3], breaks=seq(-50, 50, 0.2), prob=T,
     col=c_dark, border=c_dark_highlight, add=T)
